...
- Keep Python dependencies and command-line usage easy to reproduce.
...
For Python changes, run the project tests or the smallest command that exercises the changed behavior.
